...
$rows_per_page = 5;
//công thức tình toán chỉ số key
$per_rows = $page*$rows_per_page-$rows_per_page;
//truy vấn để tính toán số bản ghi
				...
				<div class="panel panel-default">
					<div class="panel-body">
                        <table 
                            ...
                            <tbody>
                            <?php
                            $sql = "SELECT * FROM product INNER JOIN category ON product.cat_id=category.cat_id ORDER BY prd_id DESC LIMIT $per_rows, $rows_per_page";
