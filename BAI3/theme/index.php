        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            <?php echo $arr_json['title']; ?>
                            <small><?php echo $arr_json['description']; ?></small>
                        </h2>
                    </div>
                    <div class="body table-responsive">
                        <table class="table table-condensed">
                            <thead>
                                <tr>
                                    <th width="10%">#</th>
                                    <th width="60%"><?php echo $arr_json['name']; ?></th>
                                    <th width="15%" class="text-center"><?php echo $arr_json['preview']; ?></th>
                                    <th width="15%" class="text-center"><?php echo $arr_json['download']; ?></th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr class="active">
